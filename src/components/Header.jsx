...
import React, { useState, useEffect, useRef } from 'react';
import { NavLink } from 'react-router-dom';
import { ChevronDown, ChevronRight, Menu, X, Home, BookOpen, Users, Settings } from 'lucide-react';
    ...
    <header className="bg-white shadow-sm py-4 dark:bg-gray-800">
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        <div className="hidden md:flex items-center gap-2 lg:gap-4">
          <NavLink
            to="/"
            className="px-2 lg:px-3 py-1 text-sm font-medium text-orange-500 hover:text-orange-600 dark:text-orange-400 dark:hover:text-orange-500 flex items-center"
            onClick={showAllStories}
          >
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              aria-haspopup="true"
            >
              <BookOpen className="mr-1 h-4 w-4" /> Browse Categories {activeCategory && `(${activeCategory})`} <ChevronDown className="ml-1 h-4 w-4" />
            </button>
          ...
          <NavLink
            ...
            className="px-2 lg:px-3 py-1 text-sm font-medium text-orange-500 hover:text-orange-600 dark:text-orange-400 dark:hover:text-orange-500 flex items-center"
          >
            <Users className="mr-1 h-4 w-4" /> About Us
          </NavLink>
          
          <button
            className={`px-2 lg:px-3 py-1 cursor-pointer text-sm font-medium text-orange-500 hover:text-orange-600 dark:text-orange-400 dark:hover:text-orange-500 flex items-center ${
              isAccessibilityEnabled  
            }`}
            onClick={() => setIsAccessibilityEnabled(!isAccessibilityEnabled)}
          >
            <Settings className="mr-1 h-4 w-4" /> Accessibility: {isAccessibilityEnabled ? "On" : "Off"}
          </button>
        </div>
          ...
          <div className="fixed inset-0 z-50 bg-gray-800 bg-opacity-75 md:hidden">
            <div className="h-full w-64 bg-white dark:bg-gray-800 shadow-xl p-4 overflow-y-auto">
              ...
              <div className="space-y-4">
                <NavLink
                  to="/"
                  className="flex items-center py-2 text-orange-500 hover:text-orange-600 dark:text-orange-400 dark:hover:text-orange-500"
                  onClick={showAllStories}
                >
                ...
                <div className="py-2">
                  ...
                  >
                    <div className="flex items-center">
                      <BookOpen className="mr-2 h-5 w-5" /> Browse Categories
                    </div>
                    <ChevronDown className={`h-5 w-5 transform ${mainDropdownOpen ? 'rotate-180' : ''}`} />
                  </button>
                ...
                <button
                  className="flex items-center py-2 w-full text-left text-orange-500 hover:text-orange-600 dark:text-orange-400 dark:hover:text-orange-500"
                  onClick={() => {
                    setIsAccessibilityEnabled(!isAccessibilityEnabled);
                    setMobileMenuOpen(false);
                  }}
                >
                  <Settings className="mr-2 h-5 w-5" /> Accessibility: {isAccessibilityEnabled ? "On" : "Off"}
                </button>
              </div>
            </div>
          </div>
