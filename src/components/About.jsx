  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
      <div className="container mx-auto px-6 text-center">
        <h1 className="text-4xl font-bold text-orange-500 dark:text-orange-400 mb-6">
          About Us
        </h1>
        ...
        <h2 className="text-2xl font-semibold text-orange-500 dark:text-orange-400 mb-4">
          Our Mission
        </h2>
        <p className="text-lg text-gray-700 dark:text-gray-300 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
            ...
            <div className="flex justify-center gap-4">
              <a href="https://github.com/Ankit3060" target="_blank" rel="noopener noreferrer">
                <FaGithub className="text-xl text-gray-700 hover:text-orange-500" />
              </a>
              <a href="https://www.linkedin.com/in/ankit-kumar-511b31229/" target="_blank" rel="noopener noreferrer">
                <FaLinkedin className="text-xl text-gray-700 hover:text-orange-500" />
              </a>
            </div>
          </div>
